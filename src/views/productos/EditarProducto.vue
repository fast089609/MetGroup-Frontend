        ...
        >
          <div class="w-100 mt-4 px-10">
            <div class="text-center">
              <h1 class="text-blue-500 font-bold text-4xl">Editar Tienda</h1>
            </div>
...
export default {
  ...
  watch: {
    dataEditar(nueva_tienda) {
      this.nombre = nueva_tienda.name;
      this.estado = nueva_tienda.status ? 1 : 0;
      this.precio = nueva_tienda.precio;
      this.tienda = nueva_tienda.storeId;
